...
namespace _5shop.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public ActionResult addUserToRole()
        {
            ...
            model.roles = Enum.GetValues(typeof(Role)).Cast<Role>().ToList();

            List<ApplicationUser> usersList = UserManager.Users.ToList();
            List<string> emails = usersList.Select(user => user.Email).ToList();
            model.allEmails = emails;
        ...
        public ActionResult addUserToRole(AddToRoleViewModel model)
        {
            ...
            UserManager.RemoveFromRole(user.Id, Role.USER.ToString());
